        ...
        if(player_action_level >= enemy_action_level)
        {
           ...
           switch(enemy_action_level)
            ...
            case 5:
                ...
                break;
            case 4:
                target_id = Attack_Potion(enemy_pet);
                a_potion--;
                potion_kind = 2;
                break;
            }
...
int enemy_level(Team team,Pet* enemy_pet,int player_id,int r_potion,int a_potion)
{
    ...
    int used = enemy_pet->is_used_potion();
    ...
    if(still_alive(team,0) == 2 && r_potion > 0)
    {
        level = 5;
    }
    else if((!(player_id == enemy_id+1 || ( player_id== 1 && enemy_id == 3) ))&&!used)
    {
        level = 4;
    }
    else if((enemy_id == player_id+1 || ( enemy_id== 1 && player_id == 3))||used)
    {
        level = 0;
    }
